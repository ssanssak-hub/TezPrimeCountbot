...
async def broadcast_title_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """دریافت عنوان - تشخیص خودکار نوع broadcast"""
    if not context.user_data.get('awaiting_message'):
        return ConversationHandler.END
...
async def broadcast_message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """دریافت متن - تشخیص خودکار نوع broadcast"""
    if not context.user_data.get('awaiting_message'):
        return ConversationHandler.END
